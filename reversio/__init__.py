...
def othello(root):
        ...
        screen = Canvas(root, width=500, height=600, background="#008000",highlightthickness=0)
        screen.pack()
        ...
        class Board:
                ...
                def update(self):
                                ...
                                for y in range(8):
                                        if self.player == 0:
                                                if valid(self.array,self.player,x,y):
                                                        screen.create_oval(68+50*x,68+50*y,32+50*(x+1),32+50*(y+1),tags="highlight",fill="#fff",outline="#fff")
                        ...
                        if not self.won:
                                ...
                                screen.create_text(250,550,anchor="c",font=("Consolas",15), text="Game Over!", fill="black")
...
if __name__ == '__main__':
        ...
        othello(root)
        root.pack()
        win.wm_title("Revers.io")
        win.iconbitmap('reversio.ico')
        root.mainloop()
